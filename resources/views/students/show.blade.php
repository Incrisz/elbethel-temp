...
<body>
    ...
    <div class="table-data">
        <table class="table-one" border="1px">
            <tr>
                <td><img src="{{ asset('public/logo.jpeg')}}" alt="logo" srcset=""></td>
                ...
                <td rowspan="2"><img src="{{ asset('public/passport.jpeg')}}" width="120px" height="140px" alt=""></td>
            </tr>
        ...
        <table class="table-three" border="1px">
            ...
            <tr>
                ...
                <td rowspan="10"><img src="{{ asset('public/Signature.jpg') }}"  alt="" srcset=""></td>
            </tr>
